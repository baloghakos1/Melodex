...
<body>
    <div class="p-6 text-gray-900">
        <form method="POST" action="{{ route('songcrud.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="lyrics" id="lyrics" value="{{ old('lyrics') }}">
                @error('lyrics')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="songwriter" id="songwriter" value="{{ old('songwriter') }}" required>
                @error('songwriter')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
