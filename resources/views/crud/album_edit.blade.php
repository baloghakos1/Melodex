...
<body>
    <div class="p-6 text-gray-900">
        <form method="POST" action="{{ route('albumcrud.update', $album->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="cover" id="cover" value="{{ old('cover', $album->cover) }}">
                @error('instrument')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                <label for="year" class="block text-sm font-medium text-gray-700">Album Year</label>
            ...
            <div class="mb-4">
                <label for="year" class="block text-sm font-medium text-gray-700">Album Genre</label>
                <input type="text" name="genre" id="genre" value="{{ old('genre', $album->genre) }}" required>
                @error('genre')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
